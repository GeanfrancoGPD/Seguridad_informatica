...
export async function apiRegisterProducto(req, res) {
  try {
    ...
    // Resolver cliente_id: si viene cliente_id usarlo, si viene cliente como nombre buscar/crear
    ...
    // Insertar en historial_producto el estado inicial
    try {
      await pool.query(
...
export async function apiUpdateProductoEstado(req, res) {
  try {
...
export async function apiRegisterQueja(req, res) {
  try {
...
export async function apiGetQuejas(req, res) {
  try {
    const result = await pool.query(
